...
extension KRProgressHUD {
    ...
    func show(withMessage message: String?,
        ...
        DispatchQueue.main.async {
            self.applyStyles()
            self.updateLayouts(message: message, attributedText: attributedText, iconType: iconType, image: image, imageSize: imageSize, isOnlyText: isOnlyText)
...
extension KRProgressHUD {
    ...
    func updateLayouts(message: String?, attributedText: NSAttributedString? = nil, iconType: KRProgressHUDIconType?, image: UIImage?, imageSize: CGSize?, isOnlyText: Bool) {
        resetLayouts()
