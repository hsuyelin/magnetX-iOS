...
extension KRProgressHUD {
    ...
    @discardableResult public static func set(cornerRadius: CGFloat) -> KRProgressHUD.Type {
        shared.hudView.layer.cornerRadius = cornerRadius
        return KRProgressHUD.self
    }
    
    @discardableResult public static func set(contents: Any?) -> KRProgressHUD.Type {
        shared.hudView.layer.contents = contents
        return KRProgressHUD.self
    }
    
    @discardableResult public static func set(size: CGSize) -> KRProgressHUD.Type {
        shared.hudView.snp.updateConstraints { (make) in
    ...
    @discardableResult public static func resetStyles() -> KRProgressHUD.Type {
        ...
        shared.hudView.layer.cornerRadius = 10
        shared.hudView.layer.contents = nil
        shared.hudView.snp.removeConstraints()
        return KRProgressHUD.self
    }
